...
from start_ptuning_margin import *
...
num_labels = 2
template = [3,3,3]
model = start_finetune_pmodel(args, device, template).to(device)
...
print('finish test')
torch.save(model, str(args.lr) + " " + str(args.epochs) + " margin_task2_finetune_checkpoint.pkl")
